...
> [!NOTE]  
> Processes, scheduler algorithm and memory allocation algorithm are all fixed in the PC class. They can easily be changed to any of the above with the necessary values for the process!
